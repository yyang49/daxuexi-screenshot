...
a=re.finditer(r"h5.cyol.com/special/daxuexi/daxuexiall[0-9]+/m.html",str1.content.decode())
link1=""
for match in a: 
  link1=match.group()
link1="http://"+link1+"?t=1"

str2 = requests.request("GET", link1, headers=headers)
b=re.finditer(r"h5.cyol.com/special/daxuexi/([a-z0-9]+)/m.html",str2.content.decode())
result=""
link2=""
for match in b: 
